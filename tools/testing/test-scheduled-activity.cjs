...
async function testScheduledActivity() {
  try {
    console.log('🔐 Creating authenticated request...');

    // Create a JWT token with user/organization info
    const payload = {
    ...
    const campaignId = '59c83ca2-3b46-4323-a78f-a43d6ba6ab27'; // From test file
    const baseUrl = 'http://localhost:4000';

    console.log('📅 Testing scheduled-activity endpoint...');
